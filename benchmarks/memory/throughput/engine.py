...
def start_llm(
    ...
    *,
    ...
    from inferscale.v1.serving.vllm import vllm_engine_kwargs, force_vllm_inprocess_mode
    ...
    kwargs = vllm_engine_kwargs(
        model=config.model, dtype=config.kv_dtype, engine=config.engine_config()
    )
