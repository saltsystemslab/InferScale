...
class RagKvAnswerClient:
    ...
    The injection path is identical to the LoCoMo pipeline: composition
        ...
        *,
        ...
        if not rag_scaffold_chunks_match(cached.scaffold_chunks, expected_scaffold):
            raise RuntimeError(
                ...
                "scaffold token ids; re-run the precompute-kv stage."
            )
    ...
    def answer(
        ...
        *,
        ...
        kv_by_layer = self._encoder.compose(parts)
