...
if [[ -n "${FLASHINFER_WORKSPACE_BASE:-}" && -z "${FLASHINFER_WORKSPACE_DIR:-}" ]]; then
  export FLASHINFER_WORKSPACE_DIR="${FLASHINFER_WORKSPACE_BASE}/.cache/flashinfer"
fi
export FLASHINFER_WORKSPACE_DIR="${FLASHINFER_WORKSPACE_DIR:-${BENCHMARK_CACHE_ROOT}/flashinfer}"
