...
def build_strict_gpu_kv_transfer_config(
    *,
    ...
    if allow_prefix_scan:
        # Match requests to registered memories by token prefix instead of a
        # single active user id; needed when one batch carries many memories.
        extra_config["allow_prefix_scan"] = True
    return {
