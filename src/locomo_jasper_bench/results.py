...
def summarize_records(
    ...
    *,
    ...
    for key in (
        ...
        "kv_local_prefix_match",
        "kv_cache_block_size",
        "kv_expected_aligned_tokens",
        "kv_uninjected_tail_tokens",
        "kv_context_window",
        "kv_context_prefix_tokens_total",
        "kv_context_prefix_tokens_max",
        "kv_context_prefix_truncated_tokens",
        "kv_store_gpu_mb",
        "kv_ttft_connector_init_count",
        "kv_ttft_connector_match_attempts",
        "kv_ttft_connector_hits",
        "kv_ttft_connector_misses",
        "kv_ttft_connector_update_state_calls",
        "kv_ttft_connector_build_meta_calls",
        "kv_ttft_connector_metadata_loads",
        "kv_ttft_connector_start_load_calls",
        "kv_ttft_connector_injected_tokens",
        "kv_ttft_connector_missing_memory_loads",
        "kv_ttft_connector_missing_layer_loads",
        "kv_ttft_connector_block_size",
        "kv_ttft_connector_last_mismatch_index",
        "kv_ttft_connector_last_prompt_tokens",
        "kv_ttft_connector_last_raw_memory_tokens",
        ...
        "kv_answer_connector_misses",
        "kv_answer_connector_update_state_calls",
        "kv_answer_connector_build_meta_calls",
        "kv_answer_connector_metadata_loads",
        "kv_answer_connector_start_load_calls",
        "kv_answer_connector_injected_tokens",
        "kv_answer_connector_missing_memory_loads",
        "kv_answer_connector_missing_layer_loads",
        "kv_answer_connector_block_size",
        "kv_answer_connector_last_mismatch_index",
        "kv_answer_connector_last_prompt_tokens",
        "kv_answer_connector_last_raw_memory_tokens",
