...
RAG_JUDGE_INSTRUCTIONS = (
    ...
    "of news articles. Compare the predicted answer to the reference answer. "
...
def build_rag_judge_messages(
    ...
    user = (
        ...
        "Return true if the prediction conveys the same essential information as the "
        "reference answer, even if worded differently. "
...
def judge_rag_answer(
    ...
    *,
    ...
    judge = judge_client.chat(
        build_rag_judge_messages(question, gold_answer, predicted_answer),
